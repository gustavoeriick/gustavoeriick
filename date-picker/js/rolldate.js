...
function D() {}
var k, P, L, O, W, H = e ? window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || function(t) {
...
return (k = A).prototype._init = function(t) {
    ...
    if (function(t, i) {
        ...
        }(!c(t) && !c(i), "Translate x or y is null or undefined."), c(e) && (e = this.scale), this.options.useTransform ? this.scrollerStyle[S.transform] = "translate(" + t + "px," + i + "px) scale(" + e + ")" + this.translateZ : (t = Math.round(t), i = Math.round(i), this.scrollerStyle.left = t + "px", this.scrollerStyle.top = i + "px"), this.options.wheel)
    ...
    baseData: function baseData() {
      return {
        ...
        opts: { //插件默认配置
          ...
          minStep: 1,
          trigger: 'tap',
          lang: { title: 'Selecione a data', cancel: 'cancelar', confirm: 'Confirma', year: '', month: '', day: '', hour: '', min: '', sec: '' }
        }
      };
    },
